  ...
  return (
    <section className="testimonials py-12 sm:py-16 md:py-20 lg:py-24 bg-gradient-to-br from-gray-50 to-white">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 text-gray-900">What Clients Really Say</h2>
        ...
        >
          <h3 className="text-2xl font-bold mb-4 text-gray-900">Ready to Solve Your Data Challenges?</h3>
